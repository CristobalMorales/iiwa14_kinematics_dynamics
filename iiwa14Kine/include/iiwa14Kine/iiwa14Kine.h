...
public:
    ...
    VectorXd obtain_pose_vector(Matrix4d pose_matrix);
    bool check_singularity(VectorXd joint_val);
    Matrix4d forward_kine_ref(VectorXd joint_val, int frame_init, int frame_end);
    MatrixXd center_of_mass(VectorXd joint_val, int frame_init);
};
